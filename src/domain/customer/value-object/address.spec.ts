...
describe("Address unit test", () => {
    it("should throw an error when street is empty", () => {
        ...
        expect(() => {
            const address = new Address({street: null, number: 1, zip: "Zip", city: "City"});
        }).toThrowError("Street is required");

        expect(() => {
            const address = new Address({street: undefined, number: 1, zip: "Zip", city: "City"});
        }).toThrowError("Street is required");
    });
    ...
    it("should throw an error when number is empty", () => {
        ...
        expect(() => {
            const address = new Address({street: "Street", number: null, zip: "Zip", city: "City"});
        }).toThrowError("Number is required");

        expect(() => {
            const address = new Address({street: "Street", number: undefined, zip: "Zip", city: "City"});
        }).toThrowError("Number is required");
    });
    ...
    it("should throw an error when zip is empty", () => {
        ...
        expect(() => {
            const address = new Address({street: "Street", number: 1, zip: null, city: "City"});
        }).toThrowError("Zip is required");

        expect(() => {
            const address = new Address({street: "Street", number: 1, zip: undefined, city: "City"});
        }).toThrowError("Zip is required");
    });
    ...
    it("should throw an error when city is empty", () => {
        ...
        expect(() => {
            const address = new Address({street: "Street", number: 1, zip: "Zip", city: null});
        }).toThrowError("City is required");

        expect(() => {
            const address = new Address({street: "Street", number: 1, zip: "Zip", city: undefined});
        }).toThrowError("City is required");
    });
